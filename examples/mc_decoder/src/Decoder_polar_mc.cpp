...
Decoder_polar_mc
::Decoder_polar_mc(const std::string &name, const std::string &prefix)
: Decoder(name, prefix)
{
	this->type   = "SC";
	this->implem = "FAST";
...
Decoder_polar_mc* Decoder_polar_mc
::clone() const
{
	return new Decoder_polar_mc(*this);
}
...
module::Decoder_SISO<B,Q>* Decoder_polar_mc
...
module::Decoder_SIHO<B,Q>* Decoder_polar_mc
